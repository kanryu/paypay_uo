...
part 'create_pending_payment_payload.freezed.dart';
part 'create_pending_payment_payload.g.dart';

@freezed
class CreatePendingPaymentPayload with _$CreatePendingPaymentPayload {
  factory CreatePendingPaymentPayload({
    /// [Required]
  ...
  }) = _CreatePendingPaymentPayload;

  factory CreatePendingPaymentPayload.fromJson(Map<String, dynamic> json) =>
      _$CreatePendingPaymentPayloadFromJson(json);
}
