...
part 'create_payment_auth_payload.freezed.dart';
part 'create_payment_auth_payload.g.dart';

@freezed
class CreatePaymentAuthPayload with _$CreatePaymentAuthPayload {
  factory CreatePaymentAuthPayload({
    /// [Required]
  ...
  }) = _CreatePaymentAuthPayload;

  factory CreatePaymentAuthPayload.fromJson(Map<String, dynamic> json) =>
      _$CreatePaymentAuthPayloadFromJson(json);
}
