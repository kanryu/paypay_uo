...
_$_CreateContinuousPaymentPayload _$$_CreateContinuousPaymentPayloadFromJson(
...
Map<String, dynamic> _$$_CreateContinuousPaymentPayloadToJson(
        _$_CreateContinuousPaymentPayload instance) =>
    <String, dynamic>{
